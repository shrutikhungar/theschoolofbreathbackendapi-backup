...
const breathworkRoutes = require('../routes/breathwork.routes')
const userBreathingProgressRoutes = require('../routes/userBreathingProgress.routes')
const customBreathingRoutes = require('../routes/customBreathing.routes')
const app = express()
...
app.use('/breathwork', breathworkRoutes)
app.use('/user-breathing-progress', userBreathingProgressRoutes)
app.use('/custom-breathing', customBreathingRoutes)
module.exports = app
